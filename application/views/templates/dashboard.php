...
<head>
    ...
    <title><?= $title; ?> | Inventory Daraging Karawang</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-success justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3" >Inventory Daraging Karawang</div>
            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy;Inventory Warehouse 2021 </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
